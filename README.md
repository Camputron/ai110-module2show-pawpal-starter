...
- **Time-based sorting** — Tasks with a scheduled time (HH:MM) are ordered chronologically; unscheduled tasks go last.
- **Priority sorting** — Within each time slot, high-priority tasks are placed before medium and low.
